...
/// @brief logs network events ; drives the status led while the commissioning window is open
/// @param event
/// @param arg
...
/// @brief called when an attr val changes ; updates hw accordingly (drives the relay for the OnOff cluster)
/// @param type
/// @param endpoint_id
/// @param cluster_id
/// @param attribute_id
